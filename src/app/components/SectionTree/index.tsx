        ...
        <section>
            ...
            <div className="flex items-center min-h-screen justify-center">
                <div className="flex flex-col w-1/2 text-white max-md:w-10/12">
                    ...
                    <p className="pb-2 text-lg max-md:text-xs leading-relaxed" data-aos="fade-left" >
                        ...
                        Contamos com um portfólio de mais de 2500 produtos, todos disponíveis em nosso site e e-commerce.
                    </p>
